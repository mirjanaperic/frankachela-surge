...
var _form = require("./_project/form");
...
var _marqueeDefault = parcelHelpers.interopDefault(_marquee);
var _scroll = require("./_project/scroll");
var _scrollDefault = parcelHelpers.interopDefault(_scroll);
var _imgAnimation = require("./_project/img-animation");
...
},{}],"9X2Ey":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
const banner = {
    init: function() {
        ...
        function logoHide() {
            ...
            if (window.scrollY > bannerImg.clientHeight / 2) bannerTitle.style.display = "none";
            else bannerTitle.style.display = "block";
        }
            ...
            if (_body) {
                ...
                if (gsap.matchMedia) {
                    ScrollTrigger.matchMedia = function(vars) {
                        var mm, p;
                        for(p in vars)mm ? mm.add(p, vars[p]) : mm = gsap.matchMedia(p, vars[p]);
                        return mm;
                    };
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eGnPO":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
const imgAnimation = {
    init: function() {
        var current = 0, slides = document.getElementsByClassName("js-img-about");
        setInterval(function() {
            for(var i = 0; i < slides.length; i++)slides[i].style.opacity = 0;
            current = current != slides.length - 1 ? current + 1 : 0;
            slides[current].style.opacity = 1;
        }, 3000);
        var currentContact = 0, slidesContact = document.getElementsByClassName("js-img-contact");
        setInterval(function() {
            for(var i = 0; i < slidesContact.length; i++)slidesContact[i].style.opacity = 0;
            currentContact = currentContact != slidesContact.length - 1 ? currentContact + 1 : 0;
            slidesContact[currentContact].style.opacity = 1;
        }, 3000);
        var currentBanner = 0, slidesBanner = document.getElementsByClassName("js-img-banner");
        setInterval(function() {
            for(var i = 0; i < slidesBanner.length; i++)slidesBanner[i].style.opacity = 0;
            currentBanner = currentBanner != slidesBanner.length - 1 ? currentBanner + 1 : 0;
            slidesBanner[currentBanner].style.opacity = 1;
        }, 3000);
    }
};
exports.default = imgAnimation;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["4qavH","8ZNvh"], "8ZNvh", "parcelRequire716c")
